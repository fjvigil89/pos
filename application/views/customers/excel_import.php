<?php $this->load->view("partial/header"); ?>
		...
		<div class="page-title">
			<h1>
				...
				<?php echo lang('customers_import_customers_from_excel'); ?>
			</h1>
		</div>
		<!-- END PAGE TITLE -->		
	</div>
					...
					<?php echo form_open_multipart('customers/do_excel_import/',array('id'=>'item_form','class'=>'form-horizontal')); ?>
						...
						<div class="row">
							<div class="col-md-12 col-lg-6 margin-bottom-05">
								<a class="btn btn-primary btn-block" href="<?php echo site_url('customers/excel'); ?>">
									<span class="letter-space"><?php echo lang('customers_new_customers_import'); ?></span>
								</a>
							</div>
							<div class="col-md-12 col-lg-6">						
								<a class="btn btn-primary btn-block " href="<?php echo site_url('customers/excel_export'); ?>">
									<span class="letter-space"><?php echo lang('customers_update_customers_import'); ?></span>
								</a>
							</div>
						</div>
