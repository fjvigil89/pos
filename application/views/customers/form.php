	...
	<!-- BEGIN PAGE TITLE -->
		<div class="page-title">
			<h1>
				...
				<?php if(!$person_info->person_id) { echo lang($controller_name.'_new'); } else { echo lang($controller_name.'_update'); } ?>
			</h1>
		</div>
		<!-- END PAGE TITLE -->		
	</div>
					...
					<h4><?php echo lang('common_fields_required_message'); ?></h4>
						...
						{ ?>
							<div class="form-group">	
								<?php echo form_label(lang('customers_store_account_balance').':', 'balance',array('class'=>'col-md-3 control-label')); ?>
								<div class="col-md-8">
							...
							<div class="form-group">	
								<?php echo form_label(lang('customers_credit_limit').':', 'credit_limit',array('class'=>'col-md-3 control-label')); ?>
								<div class="col-md-8">
									<?php echo form_input(array(
										'name'=>'credit_limit',
										'id'=>'credit_limit',
						...
						<div class="form-group">	
							<?php echo form_label(lang('config_company').':', 'company_name',array('class'=>'col-md-3 control-label')); ?>
							<div class="col-md-8">
								<?php echo form_input(array(
									'name'=>'company_name',
						...
						?>
							<div class="form-group">	
								<?php echo form_label(lang('config_value_point_accumulated').':', 'value_point',array('class'=>'col-md-3 control-label ')); ?>
								<div class="col-md-8">
									<?php echo form_input(array(
										'name'=>'value_point',
										'id'=>'value_point',
						...
						<div class="form-group">	
							<?php echo form_label("Identificación/".lang('customers_account_number').':', 'account_number',array('class'=>'col-md-3 control-label ')); ?>
							<div class="col-md-8">
								<?php echo form_input(array(
									'name'=>'account_number',
									'id'=>'account_number',
						...
						<div class="form-group">	
							<?php echo form_label(lang('customers_taxable').':', 'taxable',array('class'=>'col-md-3 control-label')); ?>
							<div class="col-md-8">
		...
		function doCustomerSubmit(form)
		{
			...
			$(form).ajaxSubmit({
				success:function(response)
				{
					...
					{
						//$.post('<?php //echo site_url("technical_supports/select_customer");?>', {customer: response.person_id}, function()
						//{
							window.location.href = '<?php echo site_url('technical_supports/view/-1'); ?>'
						//});
