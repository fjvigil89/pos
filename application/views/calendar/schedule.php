    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a class="btn green  btn-default" href="<?php echo site_url().'/citas/calendar' ?>">
                        Calendar
                                ...
                                <tr data-index=<?php echo $key ?>>
                                    ...
                                    <?php if($value['status']==true) { ?>
                                        <div class="onoffswitch">
                                            ...
                                            <input onClick="Habilitar('<?php echo $value['id']; ?>; ?>')" type="checkbox" name="onoffswitch" class="onoffswitch-checkbox"
