                    ...
                    <div class="col-md-3 col-sm-12">
                        ...
                        <div id="external-events">
                            <form class="inline-form">
								...
								<input type="hidden" value="" class="form-control" placeholder="start"
								id="event_start" name="start">
								<input type="hidden" value="" class="form-control" placeholder="end"
								id="event_end" name="end">
                                <br>
