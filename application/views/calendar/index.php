...
.onoffswitch-inner:after {
    content: "OFF";
    padding-right: 6px;
    background-color: #B8FAA8; color: #141111;
    text-align: right;
}
.onoffswitch-switch {
    display: block; width: 11px; margin: 7.5px;
    background: #FFFFFF;
...
.onoffswitch-checkbox:checked + .onoffswitch-label .onoffswitch-switch {
    ...
    <!--CSS para calendar-->
    <!--comun-->
    <link href=<?php echo base_url()."assets/global/plugins/fullcalendar/common/bootstrap.min.css" ?> rel="stylesheet"
        type="text/css" />
    <link href=<?php echo base_url()."assets/global/plugins/fullcalendar/common/bootstrap-switch.min.css" ?>
        rel="stylesheet" type="text/css" />
    <!--fin-->

    <link href=<?php echo base_url()."assets/global/plugins/datatable/css/datatables.min.css" ?> rel="stylesheet"
        type="text/css" />
    <link href=<?php echo base_url()."assets/global/plugins/datatable/css/datatables.bootstrap.css" ?> rel="stylesheet"
        type="text/css" />
    <link href=<?php echo base_url()."assets/global/plugins/datatable/css/bootstrap-dateppicker3.min.css" ?>
        rel="stylesheet" type="text/css" />
    <link href=<?php echo base_url()."assets/global/plugins/datatable/css/bootstrap-table.min.css" ?> rel="stylesheet"
        type="text/css" />
    ...
    <link href=<?php echo base_url()."assets/global/plugins/fullcalendar/components.min.css" ?> rel="stylesheet"
        type="text/css" />
    <link href=<?php echo base_url()."assets/global/plugins/fullcalendar/plugins.min.css" ?> rel="stylesheet"
        type="text/css" />
    <link href=<?php echo base_url()."assets/global/plugins/fullcalendar/common/layout.min.css" ?> rel="stylesheet"
        type="text/css" />
    <link href=<?php echo base_url()."assets/global/plugins/fullcalendar/common/darkblue.min.css" ?> rel="stylesheet"
        type="text/css" />
    <link href=<?php echo base_url()."assets/global/plugins/fullcalendar/common/custom.min.css" ?> rel="stylesheet"
        type="text/css" />
    <!--fin-->
    <?php
...
?>
    ...
    <!-- BEGIN CORE PLUGINS -->
    <!--esto es standar-->
    <script src=<?php echo base_url()."assets/global/plugins/fullcalendar/jquery.min.js" ?> type="text/javascript">
    </script>
    <script src=<?php echo base_url()."assets/global/plugins/fullcalendar/bootstrap.min.js" ?> type="text/javascript">
    </script>
    <script src=<?php echo base_url()."assets/global/plugins/fullcalendar/common/js.cookie.min.js" ?>
        type="text/javascript"></script>
    <script src=<?php echo base_url()."assets/global/plugins/fullcalendar/common/jquery.slimscroll.min.js" ?>
        type="text/javascript"></script>
    <script src=<?php echo base_url()."assets/global/plugins/fullcalendar/common/jquery.blockui.min.js" ?>
        type="text/javascript"></script>
    <script src=<?php echo base_url()."assets/global/plugins/fullcalendar/common/bootstrap-switch.min.js" ?>
        type="text/javascript"></script>
    <!--fin-->
    ...
    <script src=<?php echo base_url()."assets/global/plugins/fullcalendar/fullcalendar.min.js" ?>
        type="text/javascript"></script>
    <script src=<?php echo base_url()."assets/global/plugins/fullcalendar/jquery-ui.min.js" ?> type="text/javascript">
    </script>
    ...
    <script src=<?php echo base_url()."assets/global/plugins/fullcalendar/calendar.min.js" ?> type="text/javascript">
    </script>
    ...
    <!--esto es standar-->
    <script src=<?php echo base_url()."assets/global/plugins/fullcalendar/layout.min.js" ?> type="text/javascript">
    </script>
    <script src=<?php echo base_url()."assets/global/plugins/fullcalendar/demo.min.js" ?> type="text/javascript">
    </script>
    <script src=<?php echo base_url()."assets/global/plugins/fullcalendar/quick-sidebar.min.js" ?>
        type="text/javascript"></script>
    <script src=<?php echo base_url()."assets/global/plugins/fullcalendar/quick-nav.min.js" ?> type="text/javascript">
    </script>
</body>
