<?php $this->load->view("partial/header"); ?>
		...
		<div class="page-title">
			<h1>
				...
				<?php echo lang('items_mass_import_from_excel_compare'); ?>
			</h1>
		</div>
		<!-- END PAGE TITLE -->		
	</div>
		...
		<div class="col-md-12">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					<?php echo form_open_multipart('items/do_excel_import_compare/',array('id'=>'item_form','class'=>'form-horizontal')); ?>
					<h2><?php echo lang('common_step_1'); ?>: </h2>
					<p><?php echo lang('items_step_1_desc'); ?></p>
					<div class="row">
						<div class="col-md-12 col-lg-6 margin-bottom-05">
							<a class="btn btn-primary btn-block" href="<?php echo site_url('items/excel_compare'); ?>">
								<span class="letter-space"><?php echo lang('items_new_items_import_compare'); ?></span>
							</a>
						</div>
					</div>
					...
					$(form).ajaxSubmit({
						success:function(response)
						{
							...
							else
							{
								...
								window.location.href = "<?php echo site_url().'/items/do_excel_import_compare/';?>"+response.flag;
							}							
