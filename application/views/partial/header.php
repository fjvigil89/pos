...
//print_r($arr_theme); die();
	...
	?>" id="vContenido">
		...
		<div class="page-header navbar <?php 
			...
			?>">
            <div id="ventanaVer" class="Ventana-modal" style="z-index: 200000;height: auto;overflow: hidden;position: absolute;"></div>
					...
					<div class="page-actions">
						...
						<div class="btn-group">
                            <?php if ( $_SESSION['days_left'] <= 5 or ( $this->config->item('license_type') == 'lifetime' and $_SESSION['days_left'] <= 15 )): ?>
								<a class="btn btn-danger" target="_blank" href="<?php echo base_url();?>index.php/home/subscription_renewal_redirect">
    								<span class="hidden-sm hidden-xs"><?php echo $_SESSION['days_left'].' '.lang("common_licence_about_to_expire");?>&nbsp;</span><i class="fa fa-exclamation-triangle"></i>
    							</a>
                            <?php else:?>	
								<a class="btn btn-primary dropdown-toggle" target="_blank" href="<?php echo base_url();?>index.php/home/subscription_renewal_redirect">
						...
						<div class="btn-group nav-bars" >							
							<a href="javascript:;" class="btn-group btn red-haze" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
								<span class="hidden-sm hidden-xs"><?php echo lang("common_tutorials");?>&nbsp;</span><i class="fa fa-life-ring"></i>
								</a>															
								<ul class="dropdown-menu list_nav <?php 
									...
									<li>
										...
										<ul>
										<li><a  onclick="ver_video(this)" data-video="PRESENTACIÓN" <?php  echo isset($presentacio_url_video)?$presentacio_url_video:"" ?> class="icon fa fa-dashboard" >Presentación</a></li>
										<li><a  onclick="ver_video(this)" data-video="CONFIGURACIÓN" <?php  echo  isset($configuracion_url_video)? $configuracion_url_video:""?> class="icon fa fa-cogs help_button">Configuración</a></li>	
										<!--<a class="icon fa fa-cogs" data-toggle="modal"  data-target="#stack2">Configuración</a>--></li>		
										<li><a onclick="ver_video(this)" data-video="TIENDAS" <?php  echo isset($tiendas_url_video)? $tiendas_url_video:"" ?> class="icon fa fa-home help_button">Tienda</a></li>
										<!--<a class="icon fa fa-home" data-toggle="modal"  data-target="#stack6">Tiendas</a>--></li>
										<li><a  onclick="ver_video(this)" data-video="PROVEEDORES" <?php  echo isset($proveedores_url_video)?$proveedores_url_video:""?> class="icon fa fa-download" >Proveedores</a></li>
										<li><a  onclick="ver_video(this)" data-video="INVENTARIO" <?php  echo isset($inventario_url_video)?$inventario_url_video:""?>  class="icon fa fa-table" >Inventario</a></li>
										<li><a onclick="ver_video(this)" data-video="VENTAS" <?php  echo isset($venta_url_video)?$venta_url_video:""?> class="icon fa fa-shopping-cart" >Ventas</a></li>
										<li><a onclick="ver_video(this)" data-video="SERVICIO TÉCNICO" <?php  echo isset($reporte_url_video)?$reporte_url_video:""?> class="icon fa fa-bar-chart-o">Reportes</a></li>
										<li><a onclick="ver_video(this)" data-video="REPORTES" <?php  echo isset($servicio_tecnico_url_video)?$servicio_tecnico_url_video:""?> class="icon fa fa-wrench help_button" >Servicio Técnico</a>
										<!--<a class="icon fa fa-wrench" data-toggle="modal"  data-target="#stack7">Servicio Técnico</a>--></li>
						...
						<div class="btn-group pull-right">
							...
							<a class="btn green-jungle" target="_blank" href="<?php echo $api_wsp ?>">
								<span class="hidden-sm hidden-xs"><?php echo lang("common_support");?>&nbsp;</span><i class="fa fa-whatsapp"></i>
							</a>									
						</div>
						...
						<?php if($this->Appconfig->is_offline_sales()):?>
							<div class="btn-group pull-right">
								<button class="btn green"  id="btn-offline" style="display:none;">
									<span class="hidden-sm hidden-xs"><?php echo "Offline";?>&nbsp;</span><i id ="icon-offline" class="fa fa-plug"></i>
								</button>									
							</div>
						<?php endif;?>
						<!-- Dropdown Locations -->
						...
						<ul class="nav navbar-nav pull-right">
							...
							<li class="dropdown dropdown-user <?php 
								...
								<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
									...
									<img alt="" class="img-circle" src="<?php echo (isset($user_info->image_id)) ? site_url("app_files/view/$user_info->image_id") : base_url("img/avatar.jpg"); ?>"/>
								</a>
								<ul class="dropdown-menu dropdown-menu-default">
									<li>
										<a href="<?php echo base_url();?>index.php/employees/view/<?php echo $this->Employee->get_logged_in_employee_info()->person_id;?>">
