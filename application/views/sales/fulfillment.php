	...
	<div class="portlet light">
		<div class="portlet-body">
			<div id="receipt_wrapper">
				...
				<div class="well" id="receipt_general_info">
				...
				<div class="row">
					<div class="pull-right">
						<button class="btn btn-success hidden-print" id="new_sale_button_1" onclick="window.location='<?php echo site_url('sales'); ?>'" > 
							<?php echo lang('sales_new_sale'); ?> 
						</button>
						<button class="btn btn-success hidden-print" id="print_button" onclick="print_fulfillment()" > 
