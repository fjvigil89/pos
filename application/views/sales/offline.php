                                    ...
                                    <div class="portlet-body">
                                        <div class="row">
                                            <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
                                                <form action="" method="post" accept-charset="utf-8" id="add_item_form" class=""
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="item"  id="item" class="form-control form-inps-sale ui-autocomplete-input"
                                            ...
                                            <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                                                <form action="#" method="post" accept-charset="utf-8" id="mode_form" autocomplete="off">
                                            ...
                                            <div class="col-lg-2 col-md-12 pull-right">
                                                <div class="btn-group pull-right">
                                                    ...
                                                    <ul class="dropdown-menu pull-right">
                                                        <!--<li>
                                                            <a href="" class="" title="Ventas Suspendidas">Ventas Suspendidas</a>
                                                        </li> -->
                                                        <li>
                                                        ...
                                                        <a href="<?php echo site_url("sales/list_sales") ?>" class=""
                                                                 >Ventas del día</a>
                                                            
                                                        </li>
                                                        <li>
                                                            <a href="<?php echo site_url("sales/closing_amount_offline") ?>" class=""
                                                                 >Cerrar Caja</a>
                                                        </li>
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                            <div class="row col-md-4 pull-right">
                                                <div class="sale-buttons ">
                                                    <!-- Cancel and suspend buttons -->
                                                    <form action="" method="post" accept-charset="utf-8" id="cancel_sale_form"
                                                        autocomplete="off">
                                        ...
                                        <ul class="list-group">
                                            <li class="list-group-item no-border-top tier-style" style="border-top-left-radius: 0px; border-top-right-radius: 0px; border: 0px;">
                                                ...
                                                <div id="container_comment" class="hidden">
                                                    <div class="title-heading"  id="comment_label" for="comment">Comentarios:</div>
