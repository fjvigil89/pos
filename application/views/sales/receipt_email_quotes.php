	...
	<body>
	    <div id="receipt_wrapper" style="<?php echo is_rtl_lang()? 'direction:rtl':''?>">
			...
			<div id="receipt_general_info">
				...
				<div id="sale_id">
					<?php echo lang('sales_id').": ".$quote_id; ?>
				</div>
			...
			<table id="receipt_items">
			    ...
			    <?php foreach($payments as $payment_id=>$payment) { ?>
					<tr>
						...
						<?php } ?>
						<td colspan="2" style="<?php echo is_rtl_lang()? 'text-align: left;':'text-align: right;'?>">
							<b><?php echo $this->config->item('round_cash_on_sales') && $payment['payment_type'] == lang('sales_cash') ?  to_currency(round_to_nearest_05($payment['payment_amount'])) : to_currency($payment['payment_amount']); ?> </b> 
						</td>
				    </tr>
				<?php } ?>
