	...
	<div id="form">
		<div class="portlet box green">
			...
			<div class="portlet-body form">
				<!-- BEGIN FORM-->
				<?php /*<form id="customer_form" action="javascript:void(0)" class="form-horizontal"  enctype="multipart/form-data" onsubmit='controler("<?php echo site_url() ?>/technical_supports/saveC", $("#customer_form").serialize() ,"vista2","")'>*/ ?>
					...
					<div class="form-body">
						...
						{ ?>
							...
							<div class="form-group">	
								<?php echo form_label(lang('customers_store_account_balance').':', 'balance',array('class'=>'  control-label')); ?>
                        ...
                        <div class="col-sm-8">
						<div class="form-group">	
							<?php echo form_label(lang('config_company').':', 'company_name',array('class'=>'control-label')); ?>
                        ...
                        <div class="col-sm-12">
                            <div class="col-sm-4">
							<div class="form-group">	
								<?php echo form_label(lang('config_value_point_accumulated').':', 'value_point',array('class'=>'control-label ')); ?>
