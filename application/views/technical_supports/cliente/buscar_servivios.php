...
if($this->input->get('bas')=='') { ?>
    <div class="panel col-lg-12" style="padding: 0px;"> 
        ...
        $resultBusq=$ListarBusquedaT->num_rows(); 
         foreach ($ListarBusqueda->result() as $ListarBusqueda) {
            ...
            <div  style="padding: 7px;width: 80%;float: left;">        
                ...
                <a class="btn btn-success" href="javascript:void(0);" title="Ver registro" onclick="controler('<?php echo site_url() ?>/technical_supports/detalles_serv_tecnico/','hc=<?php echo $ListarBusqueda->Id_support; ?>','ventanaVer','');"> 
        ...
        <div class="col-lg-12 text-right" style="border-top: 1px solid #DDDDDD;background: #EEEEEE;padding: 7px 10px 10px 0;">
            <?php echo "Total Resultado: ".$resultBusq; ?>
        </div>
    </div>
    <?php
}  
    ...
    <div class="panel col-lg-12" style="padding: 0px;"> 
        <?php 
         foreach ($ListarBusqueda->result() as $ListarBusqueda) {
             ?>
            <div class="col-lg-12" style="border-bottom: 1px solid #DDDDDD;padding: 7px 0 10px 0;height: auto;overflow: hidden;">
                <a href="javascript:void(0);" title="Ver registro" onclick="controler('<?php echo site_url() ?>/technical_supports/repair/','hc=<?php echo $ListarBusqueda->Id_support; ?>','vContenido','');"> 
                    <div  class="col-lg-12">    
