						...
						<div class="col-sm-4">
							...
							<?php if ($this->config->item('customers_store_accounts') && $this->Employee->has_module_action_permission('customers', 'edit_store_account_balance', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>
								<div class="form-group">
									<?php echo form_label(lang('customers_store_account_balance') . ':', 'balance', array('class' => 'col-md-12 control-label')); ?>
									<div class="col-md-12">
								...
								<div class="form-group">
									<?php echo form_label(lang('customers_credit_limit') . ':', 'credit_limit', array('class' => 'col-md-12 control-label')); ?>
									<div class="col-md-12">
										<?php echo form_input(array(
											'name' => 'credit_limit',
											'id' => 'credit_limit',
