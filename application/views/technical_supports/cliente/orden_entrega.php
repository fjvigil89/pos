        ...
        <div class="modal-content animated bounceInRight">
            ...
            <div class="modal-header"
                ...
                <button type="button" title="Cerrar la ventana" class="btn btn-danger"
                    ...
                    data-dismiss="modal"
                    onclick="controler('<?php echo site_url() ?>/technical_supports/index/','quien=1','contTabla',$('#ventanaVer').html(''));"><span
                            ...
                            <div class="form-group" style="background: #FAFAFA;height: auto;overflow: hidden;">
                                <div class="col-lg-3" style="margin-top: 10px;overflow: hidden;">
                                    <div class="portlet light profile-sidebar-portlet bordered">
                                        <div class="portlet-title">
                                            <div class="text-center">
                                                <h4 style="font-weight: 700;">
                                                    <?php echo lang("technical_supports_customer"); ?></h4>
                                        ...
                                        if($dataServTecCliente->image_id !='') { ?>
                                            ...
                                            <?php }  else { ?>
                                            <img src="img/perfil.JPG" class="img-responsive" alt="photo"> <?php
                                        } ?>
                                        </div>
                                        <br>
                                        <div class="profile-usertitle text-center ">
                                            <div class="caption-subject bold ">
                                                <?php echo $dataServTecCliente->first_name . " ". $dataServTecCliente->last_name  ?>
                                            </div>
                                        </div>
                                            ...
                                            <ul class="nav">
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        ...
                                                        <?php echo $dataServTecCliente->email ?></a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        <i class="fa fa-mobile-phone"></i>
                                                        <?php echo $dataServTecCliente->phone_number ?></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-9" style="margin-top: 10px;height: auto;">
                                    <div class="col-lg-12" style="overflow: hidden;">
                                        <div class="col-lg-5" style="overflow: hidden;">
                                            <div class="portlet sale-summary box green">
                                                <div class="portlet-title padding">
                                                    <div class="caption">
                                                        <?php echo lang("technical_supports_pagos_y_abonos"); ?> </div>
                                                </div>
                                                <div class="portlet-body">
                                                    <ul class="list-unstyled">
                                                        <li class="list-group-item ">
                                                            <span class="sale-info" style="font-weight: 700;">
                                                                <?= lang("technical_supports_abono"); ?>: <i
                                                                    class="fa fa-img-up"></i></span>
                                                            <span class="sale-num"> <?= to_currency($abonado, 2); ?>
                                                            </span>
                                                        </li>
                                                        <?php if($dataServTecCliente->repair_cost!=0):?>
                                                        <li class="list-group-item ">
                                                            <span class="sale-info" style="font-weight: 700;">
                                                                <?= lang("technical_supports_repair_cost"); ?>: <i
                                                                    class="fa fa-img-down"></i></span>
                                                            <span class="sale-num">
                                                                <?= to_currency($dataServTecCliente->repair_cost, 2); ?>
                                                            </span>
                                                        </li>
                                                        <?php endif; ?>
                                                        <li class="list-group-item ">
                                                            <span class="sale-info" style="font-weight: 700;">
                                                                <?= lang("technical_supports_repair_mart"); ?>: <i
                                                                    class="fa fa-img-down"></i></span>
                                                            <span class="sale-num">
                                                                <?= to_currency($precio_total, 2); ?> </span>
                                                        </li>

                                                        <li class="list-group-item ">
                                                            <span class="sale-info" style="font-weight: 700;">
                                                                <?= lang("technical_supports_diferencia"); ?>: </span>
                                                            <span class="sale-num"> <?= to_currency($diferencia, 2); ?>
                                                            </span>
                                                        </li>
                                                    </ul>
                                                </div>
                                        ...
                                        <div class="portlet light box green col-lg-7"
                                            style="height: auto;overflow: hidden;">
                                            <div class="portlet-title padding">
                                                <div class="caption">
                                                    <i class="fa fa-tablet"></i>
                                                    <span
                                                        class="caption-subject bold"><?php echo lang("technical_supports_information"); ?></span>
                                                </div>
                                            </div>
                                            <li class="list-group-item col-lg-6">
                                                <span
                                                    class="name-item-summary"><?php echo lang("technical_supports_serial"); ?>:</span>
                                                <span
                                                    class="pull-right"><?php echo $dataServTecCliente->Id_support ?></span>
                                            </li>
                                            <li class="list-group-item col-lg-6">
                                                <span
                                                    class="name-item-summary"><?php echo lang("technical_supports_marca"); ?>:</span>
                                                <span class="pull-right"><?php echo $dataServTecCliente->marca ?></span>
                                            </li>
                                            <li class="list-group-item col-lg-6">
                                                <span
                                                    class="name-item-summary"><?php echo lang("technical_supports_model"); ?>:</span>
                                                <span class="pull-right"><?php echo $dataServTecCliente->model ?></span>
                                            </li>
                                            <li class="list-group-item col-lg-6">
                                                <span
                                                    class="name-item-summary"><?php echo lang("technical_supports_color"); ?>:</span>
                                                <span class="pull-right"><?php echo $dataServTecCliente->color ?></span>
                                            </li>
                                        </div>
                                        <div class="portlet light box green col-lg-12"
                                            style="height: auto;overflow: hidden;">
                                            <div class="portlet-title padding">
                                                <div class="caption">
                                                    <i class="fa fa-tablet"></i>
                                                    <span
                                                        class="caption-subject bold"><?php echo lang("technical_supports_orden_information_entrega"); ?></span>
                                                </div>
                                            </div>
                                            <li class="list-group-item col-lg-6">
                                                <span
                                            ...
                                            <li class="list-group-item col-lg-6">
                                                <span
                                                    class="name-item-summary"><?php echo lang("technical_supports_orden_observ"); ?>:</span>
                                                <span
                                                    class="pull-right"><?php echo $dataServTecCliente->observaciones_entrega ?></span>
                                            </li>
                                        </div>
                                    </div>
                                    <div class="col-lg-12" style="overflow: hidden;">
                                        <div class="portlet light box green col-lg-6"
                                            ...
                                            <div class="portlet-title padding">
                                                <div class="caption">
                                                    <i class="fa fa-tablet"></i>
                                                    <span
                                                        class="caption-subject bold"><?php echo lang("technical_supports_entrega_title_diag"); ?></span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="portlet light box green col-lg-6"
                                            ...
                                            <div class="portlet-title padding">
                                                <div class="caption">
                                                    <i class="fa fa-tablet"></i>
                                                    <span
                                                        class="caption-subject bold"><?php echo lang("technical_supports_entrega_title_resp"); ?></span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="portlet light box green col-lg-12"
                                            ...
                                            <div class="portlet-title padding">
                                                <div class="caption">
                                                    <i class="fa fa-tablet"></i>
                                                    <span
                                                        class="caption-subject bold"><?php echo lang("technical_supports_orden_ent_ubi_eq"); ?></span>
                                                </div>
                                            </div>
                                            <li class="list-group-item">
                                    ...
                                    <div class="portlet light profile-sidebar-portlet bordered"
                                        ...
                                        <div class="portlet-title">
                                            <div class="form-group">
                                                <label
                                                    class="col-lg-12 control-label"><?php echo lang("technical_supports_orden_ret_por"); ?></label>
                                                <div class="col-lg-12">
                                                    <input type="text"
                                                        value="<?php echo $dataServTecCliente->retirado_por ?>"
                                                        placeholder="<?php echo lang("technical_supports_orden_ret_por"); ?>"
                                                        id="nota" name="nota" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="text-right">
                                                ...
                                                <a href="javascript:void(0);"
                                                    ...
                                                    <button class="btn btn-danger"><span class="icon"><i
                                                        ...
                                                        <?php echo lang("technical_supports_orden_boton_imp"); ?></button>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
...
$('#apcion<?php echo $dataServTecCliente->Id_support; ?>').load(
    "<?php echo site_url() ?>/technical_supports/ver_opciones/",
    "supprt=<?php echo $dataServTecCliente->Id_support; ?>&cambOpcion=1");
</script>
...
function entregar() {
    if (confirm("Estas seguro de entragar el equipo")) {
        $.post('<?= site_url("technical_supports/set_entregar");?>', {
            "support_id": <?= $dataServTecCliente->Id_support?>,
            "retirado_por": $("#nota").val(),
        }, function(response) {
            response = JSON.parse(response);
            if (response.prespuesta) {
                toastr.success(response.mensaje, <?php echo json_encode(lang('common_success')); ?>);
            } else {
                toastr.error(response.mensaje, <?php echo json_encode(lang('common_error')); ?>);
            }
        });
    }
}*/
