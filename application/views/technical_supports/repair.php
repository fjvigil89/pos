<div class="row">
							...
							<div id="ajax-loader" style="display: none;"><?php echo lang('common_wait')." ".img(array('src' => base_url().'/img/ajax-loader.gif')); ?></div>
								...
								<?php echo form_open('technical_supports/repair_save/'.$support->Id_support,array('id'=>'support_form','class'=>'form-horizontal')); 	?>
									...
									<div class="form-group">	
										...
										<div class="form-group">
											<label class=" control-label col-md-3"><?php echo ($this->config->item("custom1_support_name")? $this->config->item("custom1_support_name"):"Personalizado 1").':'?> </label>
										...
										<div class="form-group">
											<label class=" control-label col-md-3"><?php echo ($this->config->item("custom2_support_name")? $this->config->item("custom2_support_name"):"Personalizado 2").':'?> </label>
										...
										<div class="form-group">
											<label class=" control-label col-md-3"><?php echo    lang("technical_supports_estado").':'?> </label>
										...
										<div class="form-group " >
											<label class=" control-label col-md-3"><?php echo lang("technical_supports_falla_tecnica").':'?> </label>
											<div class="col-md-8">
												<?php 
										...
										<?php if($support->state==lang("technical_supports_diagnosticado") || $support->state==lang("technical_supports_reparado") || $support->state==lang("technical_supports_aprobado")):?>
											<div class="form-group ">
												<label class=" control-label col-md-3"><?php echo lang("technical_supports_falla_tecnica2").':'?> </label>
												<div class="col-md-8">
													<?php 
												...
												<table id="respuestos_agregados" class="table table-bordered table-hover table-striped" >			
													<thead>
														...
														<?php endforeach;?>
															...
															<tr>	<th class="text-center" style="width:100%" colspan="7"><?php echo "No hay respuestos para mostrar"; ?></th>						
															</tr>
															<?php endif;?>
										...
										<?php if($support->state==lang("technical_supports_retirado")  ):?>
											...
											<div class="form-group " >
												<label class="  control-label col-md-3"><?php echo lang('technical_supports_garantia').'</a>'.':'?> </label>
												<div class="col-md-8">
													<?php echo form_input(array(
														'class'=>'form-control form-inps',
														'name'=>'date_garantia_',
											...
											<div class="form-group " >
												<label class="  control-label col-md-3"><?php echo lang('technical_supports_observaciones').'</a>'.':'?> </label>
												<div class="col-md-8">
												<?php 												
														$data_test = array(
											...
											<div class="form-group">
												<label class=" control-label col-md-3"><?php echo lang("technical_supports_repair_cost").':'?> </label>
										...
										<?php if($support->state==lang("technical_supports_recibido")):?>
											<div class="form-group " >
												<label class="required  control-label col-md-3"><?php echo '<a class="help_config_required  tooltips " data-placement="left" title="'.lang("technical_supports_falla_tecnica2").'">'.lang('technical_supports_falla_tecnica2').'</a>'.':'?> </label>
										...
										<?php if($support->state==lang("technical_supports_diagnosticado") || $support->state==lang("technical_supports_aprobado") ):?>
											<div class="form-group " >
												<label class="required  control-label col-md-3"><?php echo '<a class="help_config_required  tooltips " data-placement="left" title="'.lang("technical_supports_falla_respuestos").'"></a>'?> </label>
												...
												<table id="respuestos_agregados" class="table table-advance table-bordered " >			
														...
														<tr>																												
															...
															<td class="text-center"><input  value="" class="form-control form-inps" id="name_spare_part"</td>
															<td class="text-center"><input value="1"  class="form-control form-inps" id="quantity" type="number"</td>
										...
										<div class="form-group">	
											...
											<div class="form-group garantia_ocultar" style="display:none">
												<label class="required  control-label col-md-3"><?php echo '<a class="help_config_required  tooltips " data-placement="left" title="'.lang("technical_supports_garantia_help").'">'.lang('technical_supports_garantia').'</a>'.':'?> </label>
												<div class="col-md-8">
													<?php echo form_input(array(
														'class'=>'form-control form-inps',
														'name'=>'date_garantia',
	...
	<script>
		...
		$('#do_have_guarantee_no').change(function () {
			...
			$('#support_form').ajaxForm({target: "#contenedor", beforeSubmit: supportBeforeSubmit});
