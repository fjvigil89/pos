                                                                ...
                                                                <div class="form-body">
                                                                    <div class="col-md-12">
                                                                        <div class="input-group input-group-lg bootstrap-touchspin">
                                                                                ...
                                                                                <input id="touchspin_9" value="" name="demo4_2" class="form-control input-lg" style="display: block;" type="text" placeholder="Ingrese la falla técnica">
                                                                                <span class="input-group-addon bootstrap-touchspin-postfix btn green">
                                                                                <a href="javascript:void(0);" title="Pulse para agregar nuevas fallas" style="color: #FFFFFF;" onclick="controler('<?php echo site_url() ?>/technical_supports/ingFallaTec/','supprt=<?php echo $support->Id_support ?>&vIng=2','asigFallas2','');"> 
