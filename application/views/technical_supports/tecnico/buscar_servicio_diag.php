        ...
        <div class="col-sm-9">
                <div class="portlet box green">
                        <div class="portlet-title padding">
                                <div class="caption">
                                        <span class="caption-subject bold"><?php echo lang("technical_supports_reporte_tecnico"); ?></span>
                                </div>
                        </div>
                                    ...
                                    <div  id="asigFallas">
                                           <div class="row">
                                                    ...
                                                    <div class="form-body">
                                                        <div class="col-md-12">
                                                            <div class="input-group input-group-lg bootstrap-touchspin">
                                                                ...
                                                                <input id="touchspin_9" value="" name="demo4_2" class="form-control input-lg" style="display: block;" type="text" placeholder="<?php echo lang("technical_supports_reg_falla"); ?>">
                                                                <span class="input-group-addon bootstrap-touchspin-postfix btn green">
                                                                <a href="javascript:void(0);" title="<?php echo lang("technical_supports_reg_falla_n"); ?>" style="color: #FFFFFF;" onclick="controler('<?php echo site_url() ?>/technical_supports/ingFallaTec/','supprt=<?php echo $support->Id_support ?>&vIng=2','asigFallas2','');"> 
                                                                        ...
                                                                        <div class="blog-single-sidebar-search">
                                                                                <div class="input-icon right">
                                                                                        ...
                                                                                        <input class="form-control"
                                                                                                   ...
                                                                                                   type="text"
                                                                                                   accesskey="c" name="search_repuesto">
                                                                                </div>
                                                                        </div>
                                                                </div>
                                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="note">
                                                            <h4 class="block"><?php echo lang("technical_supports_datos_entrega_garantia"); ?></h4>
                                                            <p class="bold"><?php echo lang("technical_supports_tiene_garantia"); ?>  <span class="fa fa-check-circle"></span> <b
                                                                            class="pull-right"><?php echo lang("technical_supports_garantia"); ?></b></p>
                                                            <div class="form-group">
                                                                    <label for="comentarios" class=""><?php echo lang("technical_supports_comentarios_entrega"); ?></label>
                                                                    <textarea name="comentarios" id="" placeholder="<?php echo lang("technical_supports_ingrese_reporte"); ?>"
                                                                                      class="form-control"></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                    <label for="comentarios"><?php echo lang("technical_supports_repair_cost"); ?></label>
                    ...
                    <div class="portlet-body">
                            <div class="blog-single-sidebar bordered blog-container">
                                    <div class="blog-single-sidebar-search">
                                            <div class="input-icon right">
                                                    <i class="icon-magnifier"></i>
                                                    <input class="form-control" placeholder="<?php echo lang('common_search'); ?>" type="text" accesskey="c" name="search_equipoo" id="search_equipoo" value="<?php echo $support->Id_support ?>">
                                            </div>
                                    </div>
                            </div>
                    </div>
