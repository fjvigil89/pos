        ...
        <div class="modal-content animated bounceInRight">
            <div class="modal-header"
                ...
                <button type="button" class="btn btn-danger"
                    ...
                    data-dismiss="modal"
                    onclick="controler('<?php echo site_url() ?>/config/tservicios/','1','listarFiador',$('#ventanaVer').html(''));">
                            ...
                            <div class="col-sm-3">
                                <div class="portlet light profile-sidebar-portlet bordered">
                                    ...
                                    <div class="profile-userpic">
                                        ...
                                        <img src="<?php echo site_url() ?>/app_files/view/<?php echo $cliente_equipo->image_id ?>"
                                    ...
                                    <div class="profile-usertitle text-center ">
                                        <div class="caption-subject bold ">
                                            <?php echo $cliente_equipo->first_name . " ". $cliente_equipo->last_name  ?>
                                        </div>
                                    </div>
                                        ...
                                        <ul class="nav">
                                            ...
                                            <li>
                                                <a href="javascript:void(0)">
                                                    ...
                                                    <?php echo $cliente_equipo->phone_number ?>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="portlet light form-fit bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <?php echo lang('technical_supports_customer_serv_tec'); ?>
                                        </div>
                                    ...
                                    <div class="portlet-body form">
                                        ...
                                        <form autocomplete="off" id="form_equipo"
                                            action="<?php echo site_url() ?>/technical_supports/editar_servicio"
                                            class="form">
                                            <div class="form-body">
                                                <input type="text" name="id_support" class="hidden"
                                                    value="<?php echo $id_support ?>">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="col-sm-12">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label"><?php echo lang('technical_supports_employee_receives') ?></label>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label"><?php echo lang('common_type_team_help') ?></label>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label"><?php echo lang('technical_supports_falla_tecnica') ?></label>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="bs-select form-control"
                                                                        ...
                                                                        id="ubi_equipo" name="ubi_equipo">
                                                                        <option
                                                                            value="<?php echo $cliente_equipo->ubi_equipo; ?>">
                                                                            <?php echo $cliente_equipo->ubi_equipo; ?>
                                                                        </option>
                                                                        <?php  
                                                                    foreach($ubic as $ubic) {
                                                                        ?><option
                                                                            value="<?php echo $ubic->ubicacion; ?>">
                                                                            <?php echo $ubic->ubicacion; ?> </option><?php
                                                                    }                                                    
                                                                    ?>
                                                                    </select>
                                                                </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label"><?php echo lang('technical_supports_stat') ?></label>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label"><?php echo lang('technical_supports_marca') ?></label>
                                                                    <input type="text" name="marca" class="form-control"
                                                                        value="<?php echo $cliente_equipo->marca ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label"><?php echo lang('technical_supports_model') ?></label>
                                                                    <input type="text" name="model" class="form-control"
                                                                        value="<?php echo $cliente_equipo->model ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label"><?php echo lang('technical_supports_color') ?></label>
                                                                    <input type="text" name="color" class="form-control"
                                                                        value="<?php echo $cliente_equipo->color ?>">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="custom1"
                                                                        class="form-control"
                                                                        value="<?php echo $cliente_equipo->custom1_support_name ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="custom2"
                                                                        class="form-control"
                                                                        value="<?php echo $cliente_equipo->custom2_support_name ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label"><?php echo lang("technical_supports_abono") ?></label>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label"><?php echo lang("technical_supports_repair_cost") ?></label>
                                                                    <input type="text" name="costo" class="form-control"
                                                                        value="<?php echo $cliente_equipo->repair_cost ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label"><?php echo lang('technical_supports_accessory') ?></label>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group" id="accessory" style="display:none">
                                                                <label
                                                                    class="control-label"><?php echo lang('common_accessory') ?></label>
                                                                <textarea name="accessory" id="accessory"
                                                                    class="form-control"><?php echo $cliente_equipo->accessory ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-actions">
                                                <div class="col-md-12 text-center">
                                                    <button type="submit" class="btn green"><i class="fa fa-check"></i>
                                                        <?php echo lang('common_submit') ?></button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
