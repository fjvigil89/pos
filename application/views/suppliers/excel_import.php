	...
	<!-- BEGIN PAGE TITLE -->
		<div class="page-title">
			<h1>
				...
				<?php echo lang('suppliers_import_suppliers_from_excel'); ?>
			</h1>
		</div>
		<!-- END PAGE TITLE -->		
	</div>
				...
				<div class="panel-heading">
					<strong>
						<h3 class="panel-title">
							...
							<?php echo lang('suppliers_mass_import_from_excel'); ?>
						</h3>
					</strong>
				</div>
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-12 col-lg-6 margin-bottom-05">
							<a class="btn btn-primary btn-block" href="<?php echo site_url('suppliers/excel'); ?>">
								<span class="letter-space"><?php echo lang('suppliers_new_suppliers_import'); ?></span>
							</a>
						</div>
						<div class="col-md-12 col-lg-6">
							<a class="btn btn-primary btn-block" href="<?php echo site_url('suppliers/excel_export'); ?>">
								<span class="letter-space"><?php echo lang('suppliers_update_suppliers_import'); ?></span>
							</a>
						</div>
					</div>
