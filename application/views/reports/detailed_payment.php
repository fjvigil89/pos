				...
				<div class="portlet-body form">
					...
					<?php echo form_open('',['class'=>'form-horizontal']);?>
						<div class="form-body">
							...
							<div class="form-group">
								<?php echo form_label('<a class="help_config_options  tooltips " data-placement="left" title="'.lang("sales_payment_help").'">'.lang('sales_payment').'</a>'.' :', 'sales_payment', array('class'=>'col-md-3 control-label')); ?> 
								<div class="col-md-9">
									<?php echo form_dropdown('payment_type',$payment_options,$this->config->item('default_payment_type'), 'id="payment_type" class="form-control"');?>							
								</div>
							</div>
	...
	<script type="text/javascript" language="javascript">
		...
		$(document).ready(function()
		{
			...
			$("#generate_report").click(function()
			{
				...
				{
					var url = 'index.php/reports/detailed_payments'+'/'+$("#report_date_range_simple option:selected").val() + '/'+sale_type+'/'+payment_type+'/'+export_excel+'/'+export_pdf;
					if($("#export_pdf_yes").prop('checked'))
						window.open(url);
					else
						window.location =url;
				...
				else
				{
					...
					var url = 'index.php/reports/detailed_payments'+'/'+start_date + '/'+ end_date + '/'+sale_type+'/'+payment_type+'/'+ export_excel+'/'+export_pdf;
					if($("#export_pdf_yes").prop('checked'))
						window.open(url);
					else
						window.location =url;
