...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function()
    {
        $("#generate_report").click(function()
        {
            ...
            {
                var url = "index.php/reports/detailed_report_table" + '/' + $("#report_date_range_simple option:selected").val()+"/"+export_pdf;
                if($("#export_pdf_yes").prop('checked'))
                        window.open(url);
                    else
                        window.location =url;
            ...
            else
            {
                ...
                var url = "index.php/reports/detailed_report_table" + '/' + start_date + '/' + end_date+"/"+export_pdf;
                if($("#export_pdf_yes").prop('checked'))
                        window.open(url);
                    else
                        window.location =url;
