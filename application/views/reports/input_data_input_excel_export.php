				...
				<div class="portlet-body form">
					...
					<?php echo form_open('',['class'=>'form-horizontal']);?>
						<div class="form-body">
							...
							<div class="form-group">
								<?php echo form_label('Empleado :', 'reports_empleado', array('class'=>'col-md-3 control-label')); ?> 
								<div class="col-md-9">
									<?php echo form_dropdown('id_employee', $empleados, "all",'id="id_employee" class="form-control"'); ?>
								</div>
							</div>
	...
	<script type="text/javascript" language="javascript">
		...
		$(document).ready(function()
		{
			...
			$("#generate_report").click(function()
			{
				...
				{
					var url = window.location+'/'+$("#report_date_range_simple option:selected").val() + '/'+id_employee+ '/' + export_excel + '/' + export_pdf;
					if($("#export_pdf_yes").prop('checked'))
						window.open(url);
					else
						window.location =url;
				...
				else
				{
					...
					alert(start_date)
					var url = window.location+'/'+start_date + '/'+ end_date + '/'+id_employee+ '/' + export_excel+ '/' + export_pdf;
					if($("#export_pdf_yes").prop('checked'))
						window.open(url);
					else
						window.location =url;
