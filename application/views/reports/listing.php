        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="parent-list">
                    ...
                    <!--Schedule-->
                    <?php //if ($this->Employee->has_module_action_permission('reports', 'view_schedule', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>
                    <a href="#" class="icon-btn" id="schedule">
                        <i class="fa icon-calendar"></i>
                        <div>
                            <?php echo lang('reports_schedule'); ?>
                        </div>
                    </a>
                    <?php //} ?>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body child-list">
                ...
                <div class="list-group customers hidden">
                    <div class="btn-group btn-group-justified">
                        <a href="<?php echo site_url('reports/graphical_summary_customers');?>"
                    ...
                    <div class="btn-group btn-group-justified">
                        <a href="<?php echo site_url('reports/detailed_payments_cash');?>"
                            class="btn icon-btn letter-space">
                            <i class="fa fa-money"></i>
                            <div>
                ...
                <div class="list-group commissions hidden">
                    <div class="btn-group btn-group-justified">
                        <a href="<?php echo site_url('reports/graphical_summary_commissions');?>"
                            class="btn icon-btn letter-space">
                            <i class="fa fa-bar-chart-o"></i>
                            <div>
                                <?php echo lang('reports_graphical_reports'); ?>
                        ...
                        <a href="<?php echo site_url('reports/summary_commissions');?>"
                            class="btn icon-btn letter-space">
                            <i class="fa fa-building-o"></i>
                            <div>
                                <?php echo lang('reports_summary_reports'); ?>
                        ...
                        <a href="<?php echo site_url('reports/detailed_commissions');?>"
                            class="btn icon-btn letter-space">
                            <i class="fa fa-calendar"></i>
                            <div>
                                <?php echo lang('reports_detailed_reports'); ?>
                ...
                <div class="list-group employees hidden">
                    <div class="btn-group btn-group-justified">
                        <a href="<?php echo site_url('reports/graphical_summary_employees');?>"
                            class="btn icon-btn letter-space">
                            <i class="fa fa-bar-chart-o"></i>
                            <div>
                                <?php echo lang('reports_graphical_reports'); ?>
                ...
                <div class="list-group sales hidden">
                    <div class="btn-group btn-group-justified">
                        <a href="<?php echo site_url('reports/graphical_summary_sales');?>"
                            class="btn icon-btn letter-space">
                            <i class="fa fa-bar-chart-o"></i>
                            <div>
                                <?php echo lang('reports_graphical_reports'); ?>
                    ...
                    <div class="btn-group btn-group-justified">
                        ...
                        <a href="<?php echo site_url('reports/sales_consolidation');?>"
                            class="btn icon-btn letter-space">
                        ...
                        <a href="<?php echo site_url('reports/detailed_sales_serial');?>"
                            class="btn icon-btn letter-space">
                    ...
                    <div class="btn-group btn-group-justified">
                        ...
                        <a href="<?php echo site_url('reports/detailed_sales_rate');?>"
                            class="btn icon-btn letter-space">
                            <i class="fa fa-exchange"></i>
                            <div>
                ...
                <div class="list-group register-log hidden">
                    <div class="btn-group btn-group-justified">
                        <a href="<?php echo site_url('reports/detailed_register_log');?>"
                            class="btn icon-btn letter-space">
                            <i class="fa fa-calendar"></i>
                            <div>
                                <?php echo lang('reports_detailed_reports'); ?>
                ...
                <div class="list-group categories hidden">
                    <div class="btn-group btn-group-justified">
                        <a href="<?php echo site_url('reports/graphical_summary_categories');?>"
                            class="btn icon-btn letter-space">
                            <i class="fa fa-bar-chart-o"></i>
                            <div>
                                <?php echo lang('reports_graphical_reports'); ?>
                        ...
                        <a href="<?php echo site_url('reports/summary_categories');?>"
                            class="btn icon-btn letter-space">
                            <i class="fa fa-building-o"></i>
                            <div>
                                <?php echo lang('reports_summary_reports'); ?>
                ...
                <div class="list-group discounts hidden">
                    <div class="btn-group btn-group-justified">
                        <a href="<?php echo site_url('reports/graphical_summary_discounts');?>"
                            class="btn icon-btn letter-space">
                            <i class="fa fa-bar-chart-o"></i>
                            <div>
                                <?php echo lang('reports_graphical_reports'); ?>
                ...
                <div class="list-group items hidden">
                    <div class="btn-group btn-group-justified">
                        <a href="<?php echo site_url('reports/graphical_summary_items');?>"
                            class="btn icon-btn letter-space">
                            <i class="fa fa-bar-chart-o"></i>
                            <div>
                                <?php echo lang('reports_graphical_reports'); ?>
                ...
                <div class="list-group item-kits hidden">
                    <div class="btn-group btn-group-justified">
                        <a href="<?php echo site_url('reports/graphical_summary_item_kits');?>"
                            class="btn icon-btn letter-space">
                            <i class="fa fa-bar-chart-o"></i>
                            <div>
                                <?php echo lang('reports_graphical_reports'); ?>
