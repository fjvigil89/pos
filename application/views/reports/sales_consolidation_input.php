				...
				<div class="portlet-body form">
					...
					<?php echo form_open('',['class'=>'form-horizontal']);?>
						<div class="form-body">
							...
							<div class="form-group">
								<?php echo form_label($specific_input_name, 'specific_input_name_label', array('class'=>'col-md-3 control-label')); ?>
								<div class="col-md-9 " id='controls'>	
									<?php if (isset($search_suggestion_url)) {?>							
										...
										?>		
									<?php } else { ?>
										<?php echo form_dropdown('specific_input_data',$specific_input_data, isset($id_employee_login)? $id_employee_login:"", 'id="specific_input_data" class="form-control"'); ?>
									<?php } ?>							
								</div>
							</div>
	...
	<script type="text/javascript" language="javascript">
		...
		$(document).ready(function()
		{
			...
			$("#generate_report").click(function()
			{
				...
				{
					window.location = window.location+'/'+$("#report_date_range_simple option:selected").val()+ '/' + specific_id + '/' + export_excel;
				}
				else
				{
					...
					window.location = window.location+'/'+start_date + '/'+ end_date + '/' + specific_id + '/' + export_excel;
				}
			});
