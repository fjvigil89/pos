...
?>
	...
	<div class="row" id="form">
		...
		<div class="portlet light">
				...
				<div class="row">
					<div class="col-md-6">
						<h3><strong> <?php echo lang("reports_entrada")?></strong></h3>
						<div class="table-responsive">
							<table class="table table-bordered table-striped table-hover">
								<?php
								foreach($summary_data_date['ingresos'] as  $data_ingresos) { ?>
									<tr>
										<td><?php echo $data_ingresos['categorias_gastos']; ?></td>
										<td style="text-align: right;"><?php echo to_currency($data_ingresos['suma']); ?></td>
									</tr>								
								<?php } ?>
								<tr>
										<td><strong><?php echo"Total"; ?></strong></td>
										<td style="text-align: right;"><?php echo to_currency($summary_data_date['suma_ingreso']); ?></td>
									</tr>	
							</table>
						</div>
					...
					<div class="col-md-6">
						<h3><strong><?php echo lang("reports_salida")?></strong></h3>
						<div class="table-responsive">
							<table class="table table-bordered table-striped table-hover">
								<?php foreach($summary_data_date['egreos'] as  $data_egreos) { ?>
									<tr>
										<td><?php echo $data_egreos['categorias_gastos']; ?></td>
										<td style="text-align: right;"><?php echo to_currency($data_egreos['suma']); ?></td>
									</tr>								
								<?php } ?>
								<tr>
										<td><strong><?php echo"Total"; ?></strong></td>
										<td style="text-align: right;"><?php echo to_currency($summary_data_date['suma_egreoso']); ?></td>
									</tr>	
							</table>
							</table>
						</div>			
