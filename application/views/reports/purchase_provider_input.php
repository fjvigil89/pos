	...
	<script type="text/javascript" language="javascript">
		...
		$(document).ready(function()
		{
			...
			$("#generate_report").click(function()
			{
				...
				{
					var url = 'index.php/reports/purchase_provider'+'/'+$("#report_date_range_simple option:selected").val() + 'all/-1/'+export_excel+'/'+export_pdf;
					if($("#export_pdf_yes").prop('checked'))
						window.open(url);
					else
						window.location =url;
				...
				else
				{
					...
					var url = 'index.php/reports/purchase_provider'+'/'+start_date + '/'+ end_date + 'all/-1/'+ export_excel+'/'+export_pdf;
					if($("#export_pdf_yes").prop('checked'))
						window.open(url);
					else
						window.location =url;
