	...
	<script type="text/javascript" language="javascript">
		...
		$(document).ready(function()
		{
			...
			$("#generate_report").click(function()
			{
				...
				{
					var url= window.location+'/'+$("#report_date_range_simple option:selected").val()+ '/' +  store + '/' + export_excel +'/' + export_pdf;
				...
				else
				{
					...
					var url=  window.location+'/'+start_date + '/'+ end_date + '/' + store + '/'+ export_excel+ '/' + export_pdf;
