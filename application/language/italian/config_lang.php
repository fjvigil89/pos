...
$lang['config_backup_phpmyadmin_2'] = 'Il tuo nome utente è root e la password è quello che hai usato durante l\'installazione iniziale di POS Ingeniando Web. Una volta effettuato il login selezionare il database dal pannello di sinistra. Quindi selezionare l\'esportazione e poi inviare il modulo.';
...
$lang['config_company_info_help_video'] = 'dare clicca per vedere il video';
$lang['config_company_info_help'] = 'Questo menù permette di configurare i dati della società';
$lang['config_company_info_logo_help'] = 'dare clic su Sfoglia per individuare il logo ';
$lang['config_company_regimen_help'] = 'Se si paga le tasse è semplificata regime Altrimenti sistema comune';
$lang['config_tax_currency_info_help'] ='Questo menu permette di impostare imposte sui prodotti';
$lang['config_tax_currency_prices_include_help'] = 'Seleziona solo se i prezzi sono già fiscale';
$lang['config_interface_personalization_help'] = 'Questo menu consente di impostare le opzioni mostrate nei moduli vendite, gli acquisti di inventario';
$lang['config_sales_receipt_help'] = 'Questo menu consente di configurare le informazioni visualizzate sulla ricevuta e di vendita';
$lang['config_sales_receipt_prefix_help'] = 'Questo è il nome di come si chiamerà la ricevuta stampata';
$lang['config_sales_receipt_id_interface_help'] = 'Seleziona come il prodotto viene identificato nel modulo di vendita';
$lang['config_sales_receipt_print_after_help'] = 'Selezionare per la ricezione di stampa dopo aver completato la vendita';
$lang['config_sales_receipt_confirmation_sale_help'] = 'Seleziona per il sistema non dà la conferma di vendita';
$lang['config_sales_receipt_track_cash_help'] = 'Selezionare per il sistema per monitorare il registratore di cassa';

$lang['config_application_settings_help'] = 'Questo menu consente di effettuare le impostazioni generali per lapplicazione';
$lang['config_application_settings_store_accounts_help'] = 'Selezionare solo se si vende a credito';
$lang['config_application_settings_show_image_help'] = 'Selezionare per visualizzare limmagine del prodotto nelle relazioni';
$lang['config_application_settings_system_point_help'] = 'Seleziona solo se dato punti vendita';
$lang['config_application_settings_show_point_help'] = 'Selezionare per visualizzare le voci sulla fattura';
?>