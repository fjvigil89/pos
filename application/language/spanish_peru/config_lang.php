...
$lang['config_backup_phpmyadmin_2'] = 'Su nombre de usuario es root y la contraseña es la que se utiliza durante la instalación inicial de POS Overall Web PDV. Una vez conectado, seleccione la base de datos desde el panel de la izquierda. A continuación, seleccione la exportación y luego enviar el formulario.';
...
$lang['config_value_point']='Valor del punto';
