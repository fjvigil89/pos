...
$lang['config_backup_phpmyadmin_2'] = 'Nama pengguna Anda adalah root dan password adalah apa yang Anda gunakan selama instalasi awal POS Ingeniando Web. Setelah login pilih database Anda dari panel di sebelah kiri. Kemudian pilih ekspor dan kemudian menyerahkan formulir.';
...
$lang['config_company_info_help_video'] = 'Berikan klik untuk melihat video yang';
$lang['config_company_info_help'] = 'menu ini memungkinkan Anda untuk mengkonfigurasi data perusahaan';
$lang['config_company_info_logo_help'] = 'Berikan klik Browse untuk mencari logo';
$lang['config_company_regimen_help'] = 'Jika Anda membayar pajak disederhanakan rezim sistem Jika tidak umum';
$lang['config_tax_currency_info_help'] ='menu ini memungkinkan Anda untuk mengatur pajak atas produk';
$lang['config_tax_currency_prices_include_help'] = 'Pilih hanya jika harga sudah pajak';
$lang['config_interface_personalization_help'] = 'Menu ini memungkinkan Anda mengatur opsi yang ditampilkan dalam modul penjualan, pembelian persediaan';
$lang['config_sales_receipt_help'] = 'menu ini memungkinkan Anda untuk mengkonfigurasi informasi yang ditampilkan pada penerimaan dan penjualan';
$lang['config_sales_receipt_prefix_help'] = 'Ini adalah nama dari bagaimana penerimaan dicetak akan disebut';
$lang['config_sales_receipt_id_interface_help'] = 'Pilih bagaimana produk diidentifikasi dalam modul penjualan';
$lang['config_sales_receipt_print_after_help'] = 'Pilih untuk penerimaan cetak setelah menyelesaikan penjualan';
$lang['config_sales_receipt_confirmation_sale_help'] = 'Pilih untuk sistem tidak memberikan konfirmasi penjualan';
$lang['config_sales_receipt_track_cash_help'] = 'Pilih untuk sistem untuk memantau kasir';

$lang['config_application_settings_help'] = 'Menu ini memungkinkan Anda membuat pengaturan umum untuk aplikasi';
$lang['config_application_settings_store_accounts_help'] = 'Pilih hanya jika Anda menjual secara kredit';
$lang['config_application_settings_show_image_help'] = 'Pilih untuk menampilkan citra produk dalam laporan';
$lang['config_application_settings_system_point_help'] = 'Pilih hanya jika diberikan poin penjualan';
$lang['config_application_settings_show_point_help'] = 'Pilih untuk menampilkan item pada faktur';
?>