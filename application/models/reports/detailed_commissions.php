...
class Detailed_commissions extends Report
{
	...
	public function getData()
	{
		...
		$this->db->select('sale_id, sale_time, sale_date, sum(quantity_purchased) as items_purchased, CONCAT(first_name," ",last_name) as customer_name, sum(subtotal) as subtotal, sum(total) as total, sum(tax) as tax, sum(profit) as profit, sum(commission) as commission,is_invoice,invoice_number,ticket_number, payment_type, comment', false);
