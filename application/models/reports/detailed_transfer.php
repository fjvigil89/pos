...
class Detailed_transfer extends Report
{
	...
	{
		return array(
			'summary' => array(array('data'=>lang('reports_receiving_id'), 'align'=>'left'), array('data'=>lang('reports_date'), 'align'=>'left'), array('data'=>lang('reports_items_received'), 'align'=>'left'), array('data'=>"Transferido por", 'align'=>'left'), array('data'=>"Transferido a", 'align'=>'left'), array('data'=>lang('reports_total'), 'align'=>'right'), array('data'=>lang('reports_comments'), 'align'=>'left')),
	...
	public function getData()
	{
		...
		{
			$receiving_summary_row["name_location_envia"]=$location_name[$receiving_summary_row["location_id"]];
			$receiving_summary_row["name_location_resive"]=$location_name[$receiving_summary_row["transfer_to_location_id"]];
