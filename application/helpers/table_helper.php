						...
						$content.='<table class="table table-striped table-bordered table-hover">';
							$content.='<thead>';
								$content.='<tr>';
									...
									$content.=($employee_id==1)?'<th>'.lang("day_1").'</th>':'<th>'.lang("day_1").' <input type="checkbox" id="'.$location->location_id."_day_0[]".'" onClick="all_day_access(this,this.id)"></th>';
									$content.=($employee_id==1)?'<th>'.lang("day_2").'</th>':'<th>'.lang("day_2").' <input type="checkbox" id="'.$location->location_id."_day_1[]".'" onClick="all_day_access(this,this.id)"></th>';
									$content.=($employee_id==1)?'<th>'.lang("day_3").'</th>':'<th>'.lang("day_3").' <input type="checkbox" id="'.$location->location_id."_day_2[]".'" onClick="all_day_access(this,this.id)"></th>';
									$content.=($employee_id==1)?'<th>'.lang("day_4").'</th>':'<th>'.lang("day_4").' <input type="checkbox" id="'.$location->location_id."_day_3[]".'" onClick="all_day_access(this,this.id)"></th>';
									$content.=($employee_id==1)?'<th>'.lang("day_5").'</th>':'<th>'.lang("day_5").' <input type="checkbox" id="'.$location->location_id."_day_4[]".'" onClick="all_day_access(this,this.id)"></th>';
									$content.=($employee_id==1)?'<th>'.lang("day_6").'</th>':'<th>'.lang("day_6").' <input type="checkbox" id="'.$location->location_id."_day_5[]".'" onClick="all_day_access(this,this.id)"></th>';
									$content.=($employee_id==1)?'<th>'.lang("day_7").'</th>':'<th>'.lang("day_7").' <input type="checkbox" id="'.$location->location_id."_day_6[]".'" onClick="all_day_access(this,this.id)"></th>';
								$content.='</tr>';
							$content.='</thead>';
							$content.='<tbody>';
