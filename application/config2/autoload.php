...
$autoload['language'] = array('common', 'config', 'customers', 'datetime', 'employees', 'error', 'items', 'login', 'module', 'reports', 'sales','suppliers','receivings','giftcards', 'item_kits','locations','technical_supports','warehouse','exchange',"offline");
