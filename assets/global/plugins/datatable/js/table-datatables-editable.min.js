var TableDatatablesEditable = function() {
    ...
    var e = function() {
        ...
        function t(e, t) {
            var n = e.fnGetData(t),
                a = $(">td", t);
            a[0].innerHTML = '<input name="title" type="text" class="form-control " value="' + n[0] + '">',
                a[1].innerHTML = '<input name="detail" type="text" class="form-control " value="' + n[1] + '">',
                a[2].innerHTML = '<input name="start" type="text" class="form-control " value="' + n[2] + '">',
                a[3].innerHTML = '<input name="end" type="text" class="form-control " value="' + n[3] + '">',
                a[4].innerHTML = '<input name="color" type="text" class="form-control " value="' + n[4] + '">',

                a[5].innerHTML = `<div class="onoffswitch">                
